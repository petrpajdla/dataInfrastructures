...
## @sec-method presents: {.unnumbered}
...
This text was written in plain text with some basic _markdown_ and _quarto_ syntax for formatting, cross references, citations etc.
